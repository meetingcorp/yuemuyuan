...
@php $pagename = 'แก้ไขบทความ' @endphp
...
@section('content')
    ...
    <form method="post" action="{{ route('article.update', ['article' => $data->id]) }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="mt-4">
                                ...
                                <img src="@if ($data->getFirstMediaUrl('article')) {{ $data->getFirstMediaUrl('article') }}
