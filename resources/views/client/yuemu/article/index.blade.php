    ...
    <section class="content">
        <div class="container">
            <div class="text-center mb-4">
                <h1 style="color: #045242; font-weight:600;">บทความ</h1>
                <h2 style="color: #045242;">Article</h2>
            </div>
            <!--<div class="carousel mt-4" data-items="3" data-arrows="false" data-dots="true">
                @foreach ($articles as $articless)
                    <a href="{{ route('client.article.show', ['article' => $articless->slug]) }}">
                            ...
                            <div class="post-item border">
                                <div class="post-item-wrap"
                                    ...
                                    <div class="post-image">
                                        <img class="" src="{{ $articless->getFirstMediaUrl('article') }}"
					...
					<a href="{{ route('client.article.show', ['article' => $articless->slug]) }}">
                        <div class="post-item border">
                            <div class="post-item-wrap"
                                ...
                                <div class="post-item-description text-center">
                                    <h4 class="text-center" style="color: #045242; margin-bottom:0px;">{{ $articless->title }}</h4>
                                    <h4 class="text-center" style="font-size:16px; font-weight:400; overflow: hidden;
